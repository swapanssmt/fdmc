#ifndef MCFL_3DF_ANG_LIB_H_
#define MCFL_3DF_ANG_LIB_H_
...
void mcxyz(double Nphotons, float dx, float dy, float dz, int Nx, int Ny, int Nz, float xs, float ys, float zs, float ux0, float uy0, float uz0, float mod_freq,
			...
			double *RX_real, double *RX_imag, double *Rxa_real, double *RXa_imag, double *FM_real, double *FM_imag, double *RM_real, double *RM_imag, double *RMa_real, double *RMa_imag,
