...
myname      = 'test_broad';% name for files: myname_T.bin, myname_H.mci
...
binsize     = 0.00625; 	% size of each bin, eg. [cm] or [mm]


% SOURCE PARAMETERS
mod_freq = 500; % modulation frequency in [MHZ]
...
radius      = 0.05; %0.00400;   % 1/e radius of beam at tissue surface
...
% 1 = launch from z - face
% 2 = launch from  x - face
% 3 = launch from y - face

if launchflag~=0
    % For oblique incidence
    theta_inc = 0; % angle of incidence in degrees
    phi_inc = 0;
...
xc1 = -0.125;  zc1 = 0.075; yc1 = 0;
xc2 = 0.15; zc2 = 0.1; yc2 = 0;
xc3 = 0; zc3 = 0.15; yc3 = 0;


r1 = 0.025; r2 = 0.025; r3 = 0.025;
% % % % 
for iz = 1:Nz
 for ix=1:Nx
     for iy = 1:Ny
